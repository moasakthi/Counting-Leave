...
setup(name='counting_leave',
      version='1.1',
      description="Counting Leave is date utility functions to extend python's datetime",
      author='Siva Sakthi Velan',
      py_modules=['counting_leave'],
      url='http://github.com/ogt/workdays',
      download_url = 'http://github.com/ogt/workdays/tarball/master',
      author_email='moa_sakthi@live.in',
      keywords = ['python', 'datetime', 'leave', 'excel' ],
      classifiers = [
